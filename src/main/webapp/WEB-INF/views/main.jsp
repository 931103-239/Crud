...
<c:set var="loginOutLink" value="${loginId=='비회원' ? '/login/login' : '/login/logout'}"/>
<html>
<head>
    <meta charset="UTF-8">
...
<div id="wrap">
    <header id="header"><!--header/start-->
        <nav class="nav"><!--nav/start-->
            ...
            <div class="nav-list">
                <div class="nav-git">
                    <a class="nav-git-adr" href="https://github.com/931103-239/Crud.git">https://github.com/931103-239/Crud.git</a>
                </div><!--.nav-git-->
                <div class="nav-info">
